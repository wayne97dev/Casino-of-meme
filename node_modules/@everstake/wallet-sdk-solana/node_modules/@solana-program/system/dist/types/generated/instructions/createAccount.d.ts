 ...
 */
import { type Address, type Codec, type Decoder, type Encoder, type IAccountMeta, type IAccountSignerMeta, type IInstruction, type IInstructionWithAccounts, type IInstructionWithData, type TransactionSigner, type WritableSignerAccount } from '@solana/web3.js';
import { SYSTEM_PROGRAM_ADDRESS } from '../programs';
import { type IInstructionWithByteDelta } from '../shared';
export declare const CREATE_ACCOUNT_DISCRIMINATOR = 0;
export declare function getCreateAccountDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
