 ...
 */
import { type Address, type Codec, type Decoder, type Encoder, type IAccountMeta, type IAccountSignerMeta, type IInstruction, type IInstructionWithAccounts, type IInstructionWithData, type ReadonlySignerAccount, type TransactionSigner, type WritableAccount, type WritableSignerAccount } from '@solana/web3.js';
import { SYSTEM_PROGRAM_ADDRESS } from '../programs';
export declare const CREATE_ACCOUNT_WITH_SEED_DISCRIMINATOR = 3;
export declare function getCreateAccountWithSeedDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
