...
function getNonceStateEncoder() {
  return web3_js.getEnumEncoder(NonceState, { size: web3_js.getU32Encoder() });
}
function getNonceStateDecoder() {
  return web3_js.getEnumDecoder(NonceState, { size: web3_js.getU32Decoder() });
}
function getNonceStateCodec() {
  return web3_js.combineCodec(getNonceStateEncoder(), getNonceStateDecoder());
}
...
function getNonceVersionEncoder() {
  return web3_js.getEnumEncoder(NonceVersion, { size: web3_js.getU32Encoder() });
}
function getNonceVersionDecoder() {
  return web3_js.getEnumDecoder(NonceVersion, { size: web3_js.getU32Decoder() });
}
function getNonceVersionCodec() {
  return web3_js.combineCodec(getNonceVersionEncoder(), getNonceVersionDecoder());
}
...
function getNonceEncoder() {
  return web3_js.getStructEncoder([
    ...
    ["blockhash", web3_js.getAddressEncoder()],
    ["lamportsPerSignature", web3_js.getU64Encoder()]
  ]);
}
function getNonceDecoder() {
  return web3_js.getStructDecoder([
    ...
    ["blockhash", web3_js.getAddressDecoder()],
    ["lamportsPerSignature", web3_js.getU64Decoder()]
  ]);
}
function getNonceCodec() {
  return web3_js.combineCodec(getNonceEncoder(), getNonceDecoder());
}
...
function identifySystemInstruction(instruction) {
  ...
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(0), 0)) {
    return 0 /* CreateAccount */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(1), 0)) {
    return 1 /* Assign */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(2), 0)) {
    return 2 /* TransferSol */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(3), 0)) {
    return 3 /* CreateAccountWithSeed */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(4), 0)) {
    return 4 /* AdvanceNonceAccount */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(5), 0)) {
    return 5 /* WithdrawNonceAccount */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(6), 0)) {
    return 6 /* InitializeNonceAccount */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(7), 0)) {
    return 7 /* AuthorizeNonceAccount */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(8), 0)) {
    return 8 /* Allocate */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(9), 0)) {
    return 9 /* AllocateWithSeed */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(10), 0)) {
    return 10 /* AssignWithSeed */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(11), 0)) {
    return 11 /* TransferSolWithSeed */;
  }
  if (web3_js.containsBytes(data, web3_js.getU32Encoder().encode(12), 0)) {
...
function getAdvanceNonceAccountDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(ADVANCE_NONCE_ACCOUNT_DISCRIMINATOR);
}
function getAdvanceNonceAccountInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([["discriminator", web3_js.getU32Encoder()]]),
    (value) => ({
      ...value,
...
function getAdvanceNonceAccountInstructionDataDecoder() {
  return web3_js.getStructDecoder([["discriminator", web3_js.getU32Decoder()]]);
}
...
function getAllocateDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(ALLOCATE_DISCRIMINATOR);
}
function getAllocateInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["space", web3_js.getU64Encoder()]
    ]),
...
function getAllocateInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["space", web3_js.getU64Decoder()]
  ]);
}
...
function getAllocateWithSeedDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(ALLOCATE_WITH_SEED_DISCRIMINATOR);
}
function getAllocateWithSeedInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["base", web3_js.getAddressEncoder()],
      ["seed", web3_js.addEncoderSizePrefix(web3_js.getUtf8Encoder(), web3_js.getU64Encoder())],
      ["space", web3_js.getU64Encoder()],
      ["programAddress", web3_js.getAddressEncoder()]
    ]),
...
function getAllocateWithSeedInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["base", web3_js.getAddressDecoder()],
    ["seed", web3_js.addDecoderSizePrefix(web3_js.getUtf8Decoder(), web3_js.getU64Decoder())],
    ["space", web3_js.getU64Decoder()],
    ["programAddress", web3_js.getAddressDecoder()]
  ]);
}
...
function getAssignDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(ASSIGN_DISCRIMINATOR);
}
...
function getAssignWithSeedDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(ASSIGN_WITH_SEED_DISCRIMINATOR);
}
...
function getAuthorizeNonceAccountDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(AUTHORIZE_NONCE_ACCOUNT_DISCRIMINATOR);
}
function getAuthorizeNonceAccountInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["newNonceAuthority", web3_js.getAddressEncoder()]
    ]),
    (value) => ({
      ...value,
...
function getAuthorizeNonceAccountInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["newNonceAuthority", web3_js.getAddressDecoder()]
  ]);
}
...
function getCreateAccountDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(CREATE_ACCOUNT_DISCRIMINATOR);
}
function getCreateAccountInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["lamports", web3_js.getU64Encoder()],
      ["space", web3_js.getU64Encoder()],
      ["programAddress", web3_js.getAddressEncoder()]
    ]),
...
function getCreateAccountInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["lamports", web3_js.getU64Decoder()],
    ["space", web3_js.getU64Decoder()],
    ["programAddress", web3_js.getAddressDecoder()]
  ]);
}
...
function getCreateAccountInstruction(input, config) {
  ...
  const accounts = originalAccounts;
  const args = { ...input };
  const byteDelta = [Number(args.space) + web3_js.BASE_ACCOUNT_SIZE].reduce(
    (a, b) => a + b,
    0
  );
  const getAccountMeta = getAccountMetaFactory(programAddress);
...
function getCreateAccountWithSeedDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(CREATE_ACCOUNT_WITH_SEED_DISCRIMINATOR);
}
...
function getInitializeNonceAccountDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(INITIALIZE_NONCE_ACCOUNT_DISCRIMINATOR);
}
function getInitializeNonceAccountInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["nonceAuthority", web3_js.getAddressEncoder()]
    ]),
    (value) => ({
      ...value,
...
function getInitializeNonceAccountInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["nonceAuthority", web3_js.getAddressDecoder()]
  ]);
}
...
function getTransferSolDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(TRANSFER_SOL_DISCRIMINATOR);
}
...
function getTransferSolWithSeedDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(TRANSFER_SOL_WITH_SEED_DISCRIMINATOR);
}
function getTransferSolWithSeedInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["amount", web3_js.getU64Encoder()],
      ["fromSeed", web3_js.addEncoderSizePrefix(web3_js.getUtf8Encoder(), web3_js.getU64Encoder())],
      ["fromOwner", web3_js.getAddressEncoder()]
    ]),
    (value) => ({
      ...value,
...
function getTransferSolWithSeedInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["amount", web3_js.getU64Decoder()],
    ["fromSeed", web3_js.addDecoderSizePrefix(web3_js.getUtf8Decoder(), web3_js.getU64Decoder())],
    ["fromOwner", web3_js.getAddressDecoder()]
  ]);
}
...
function getUpgradeNonceAccountDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(UPGRADE_NONCE_ACCOUNT_DISCRIMINATOR);
}
...
function getWithdrawNonceAccountDiscriminatorBytes() {
  return web3_js.getU32Encoder().encode(WITHDRAW_NONCE_ACCOUNT_DISCRIMINATOR);
}
function getWithdrawNonceAccountInstructionDataEncoder() {
  return web3_js.transformEncoder(
    web3_js.getStructEncoder([
      ["discriminator", web3_js.getU32Encoder()],
      ["withdrawAmount", web3_js.getU64Encoder()]
    ]),
    (value) => ({
      ...value,
...
function getWithdrawNonceAccountInstructionDataDecoder() {
  return web3_js.getStructDecoder([
    ["discriminator", web3_js.getU32Decoder()],
    ["withdrawAmount", web3_js.getU64Decoder()]
  ]);
}
