...
} from "./chunk-ASGCNTGD.js";
import {
  Buffer$1,
  init_dist,
  require_safe_buffer
} from "./chunk-BVR6TZLO.js";
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        FractalWalletClass = (await import("./esm-34RAY4RO.js")).FractalWalletAdapterImpl;
      } catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let keyring;
      try {
        const { DefaultKeyring } = await import("./dist-W774O3TC.js");
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WalletClass;
      try {
        ({ ParticleNetwork: ParticleClass, SolanaWallet: WalletClass } = await import("./es-OYANGPHF.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SalmonClass;
      try {
        SalmonClass = (await import("./esm-ER7XW7UV.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
  ...
  constructor() {
    ...
    _SolflareMetaMaskWallet_connect.set(this, async () => {
      if (!__classPrivateFieldGet(this, _SolflareMetaMaskWallet_solflareMetaMask, "f")) {
        ...
        try {
          SolflareMetaMaskClass = (await import("./esm-BYUJ3PFG.js")).default;
        } catch (error) {
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("./esm-CEWGYPSY.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await import("./solanaEmbed.esm-WESGTRJT.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    ...
    try {
      ...
      let wallet;
      try {
        const { default: TrezorConnect } = await import("./lib-NZTX72XD.js");
...
var WalletConnectWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WCChainID;
      try {
        ({ WalletConnectWallet: WalletConnectClass, WalletConnectChainID: WCChainID } = await import("./esm-B7CO7OT3.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
