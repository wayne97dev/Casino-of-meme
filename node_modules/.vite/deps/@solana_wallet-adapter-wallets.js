...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        FractalWalletClass = (await import("./esm-N5CJTYTX.js")).FractalWalletAdapterImpl;
      } catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let keyring;
      try {
        const { DefaultKeyring } = await import("./dist-C57HDHRP.js");
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WalletClass;
      try {
        ({ ParticleNetwork: ParticleClass, SolanaWallet: WalletClass } = await import("./es-RHP2NMJ2.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SalmonClass;
      try {
        SalmonClass = (await import("./esm-34ZCTPCO.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
  ...
  constructor() {
    ...
    _SolflareMetaMaskWallet_connect.set(this, async () => {
      if (!__classPrivateFieldGet(this, _SolflareMetaMaskWallet_solflareMetaMask, "f")) {
        ...
        try {
          SolflareMetaMaskClass = (await import("./esm-VYSCQMQW.js")).default;
        } catch (error) {
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("./esm-ECTHQELL.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await import("./solanaEmbed.esm-MAML6JTU.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    ...
    try {
      ...
      let wallet;
      try {
        const { default: TrezorConnect } = await import("./lib-FWTMMARK.js");
...
var WalletConnectWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WCChainID;
      try {
        ({ WalletConnectWallet: WalletConnectClass, WalletConnectChainID: WCChainID } = await import("./esm-DUT2VF7A.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
