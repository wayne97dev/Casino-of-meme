...
export declare class DeviceCommands {
    ...
    private call;
    typedCall<T extends Messages.MessageKey, R extends Messages.MessageKey[]>(type: T, resType: R, msg?: Messages.MessagePayload<T>): Promise<Messages.MessageResponse<R[number]>>;
    typedCall<T extends Messages.MessageKey, R extends Messages.MessageKey>(type: T, resType: R, msg?: Messages.MessagePayload<T>): Promise<Messages.MessageResponse<R>>;
    _commonCall<T extends Messages.MessageKey>(type: T, msg: Messages.MessagePayload<T>): Promise<{
